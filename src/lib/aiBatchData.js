...
export const S2_SEQUENCE = [
  ...
  {
    module: '100 Days of Deep Learning — Part 1 (Fundamentals)',
    source: 'YouTube',
    color: '#0369A1',
    lectures: [
      'What Is Deep Learning — Perceptrons and Neural Networks',
      'History of Neural Networks — From McCulloch-Pitts to GPT',
      'How Neural Networks Learn — Forward Pass and Loss Functions',
      'Backpropagation Intuition — Chain Rule in Neural Networks',
      'Backpropagation Mathematics — Gradient Computation',
      'Gradient Descent Variants — Batch, Stochastic and Mini-Batch',
      'Activation Functions — Sigmoid, Tanh and ReLU',
      'Activation Functions Advanced — Leaky ReLU, ELU, GELU, Swish',
      'Weight Initialization — Zero, Random, Xavier and He',
      'Vanishing and Exploding Gradients Problem',
      'Batch Normalization — Theory and Implementation',
      'Dropout Regularization — Preventing Overfitting',
      'L1 and L2 Regularization in Neural Networks',
      'Optimizers — SGD with Momentum, RMSProp',
      'Adam Optimizer — Adaptive Learning Rates',
      'Learning Rate Scheduling — StepLR, CosineAnnealing',
      'Hyperparameter Tuning for Deep Learning',
      'Convolutional Neural Networks — Convolution Operation',
      'CNN Architecture — Filters, Padding and Stride',
      'Pooling Layers and Feature Maps',
      'CNN for Image Classification — LeNet to AlexNet',
      'VGG, GoogLeNet and Inception Architecture',
      'ResNet — Residual Connections and Skip Connections',
      'DenseNet and EfficientNet Architecture',
      'Transfer Learning — Feature Extraction and Fine-Tuning',
      'Data Augmentation Techniques for Computer Vision',
      'Object Detection — YOLO and SSD Overview',
      'Semantic Segmentation — U-Net Architecture',
      'Recurrent Neural Networks — Sequence Modeling',
      'RNN Training — Backpropagation Through Time (BPTT)',
      'Long Short-Term Memory (LSTM) — The What and Why',
      'LSTM Gates — Input, Forget and Output Gate',
      'Gated Recurrent Units (GRU)',
      'Bidirectional RNNs and Stacked LSTMs',
      'Sequence-to-Sequence Models — Encoder-Decoder Architecture',
      'Attention Mechanism — The Key Innovation Before Transformers',
      'Word Embeddings — Word2Vec, GloVe and FastText',
      'Text Classification with RNNs',
      'Named Entity Recognition with Bi-LSTM',
      'Generative Adversarial Networks — GAN Architecture',
      'GAN Training — The Minimax Game',
      'Deep Convolutional GAN (DCGAN)',
      'Conditional GAN (CGAN) for Controlled Generation',
      'Variational Autoencoders — VAE Theory',
      'VAE Implementation and Latent Space Exploration',
      'Autoencoders for Anomaly Detection',
      'Neural Style Transfer',
      'Deep Dream and Visualizing CNN Features',
      'Model Interpretability — Saliency Maps and Grad-CAM',
    ],
  },
  {
    module: '100 Days of Deep Learning — Part 2 (Advanced)',
    source: 'YouTube',
    color: '#0369A1',
    lectures: [
      'The Transformer Architecture — Attention Is All You Need',
      'Multi-Head Self-Attention — Theory and Implementation',
      'Positional Encoding in Transformers',
      'Transformer Encoder in Detail',
      'Transformer Decoder and Masked Attention',
      'BERT — Bidirectional Encoder Representations',
      'BERT Pre-Training — MLM and NSP Objectives',
      'BERT Fine-Tuning for Classification and NER',
      'GPT Architecture — Causal Language Modeling',
      'GPT-2 and GPT-3 — Scale and Emergent Abilities',
      ...
      'Whisper — Automatic Speech Recognition with Transformers',
      'Time Series with Transformers — Temporal Fusion Transformer',
      'Graph Neural Networks — GCN and GAT',
      'Self-Supervised Learning — SimCLR and BYOL',
      'Knowledge Distillation — Teacher-Student Training',
      'Model Quantization — INT8 and Mixed Precision',
      'Pruning and Sparsity in Neural Networks',
      'Neural Architecture Search (NAS)',
      'Federated Learning — Privacy-Preserving ML',
      'Continual Learning and Catastrophic Forgetting',
      'Multi-Task Learning Architecture',
      'Foundation Models — What Makes Them Different',
      'Scaling Laws — How Performance Scales with Size and Data',
      'RLHF — Reinforcement Learning from Human Feedback',
      'Instruction Tuning and Alignment Techniques',
      'Constitutional AI and AI Safety',
      'Production DL Systems — Serving, Monitoring and Versioning',
    ],
  },
  {
